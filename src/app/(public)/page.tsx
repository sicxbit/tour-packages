    ...
    <div className="relative">
      ...
      <div className="relative min-h-screen w-full overflow-hidden bg-transparent">
        ...
        <section className="absolute inset-0 z-10 container mx-auto flex flex-col justify-center px-6 pb-0 sm:justify-end sm:px-10 sm:pb-16 md:px-16 md:pb-24 lg:px-24 lg:pb-32 xl:px-32">
          <h2 className="text-2xl font-semibold text-white sm:text-3xl md:text-4xl">BLUE LAGOONS</h2>

          <h1 className="primary-color text-4xl font-extrabold leading-tight sm:text-5xl md:text-6xl lg:text-7xl">Island Journeys</h1>

          <BlurText
            text="Blue Lagoons curates island-first adventures with trusted local guides, clear itineraries, and seamless booking so your next tropical escape feels effortless from start to finish."
            delay={20}
