...
const features = [
  ...
  },
  {
    ...
    description:
      "We collaborate with experienced regional operators to ensure each journey is reliable, authentic, and comfortable.",
  },
  {
    title: "Seamless Planning",
    description:
      "From booking to arrival, our team keeps every step organized so your travel experience stays stress-free.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="w-full h-64 md:h-80 overflow-hidden">
        <Image src="/assets/imgs/banner/about_us 1.png" alt="Ocean aerial view" className="w-full h-full object-cover" width={1440} height={1080} />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-16 md:mb-24 items-start">
          ...
          <div className="flex justify-center md:justify-end">
            <div className="w-full md:w-80 h-64 md:h-96 rounded-3xl overflow-hidden shadow-lg">
              <Image src="/assets/imgs/banner/about1.png" alt="Starfish on sand" className="w-full h-full object-cover" width={600} height={400} />
            </div>
          </div>
        </div>
        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {features.map((feature) => (
              <div key={feature.title} className="p-6 md:p-8 bg-gray-50 rounded-xl hover:shadow-md transition-shadow duration-300">
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">{feature.title}</h3>
